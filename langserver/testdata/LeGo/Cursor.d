...
func void Cursor_Show() {
    ...
    Cursor_Hndl = View_CreatePxl(Cursor_X, Cursor_Y, Cursor_X+Cursor_Texture_W, Cursor_Y+Cursor_Texture_H);
...
func void _Cursor_GetVal() {
    ...
    Print_GetScreenSize();
    if((Cursor_X + Cursor_Texture_W) > Print_Screen[PS_X]) {
        Cursor_X = Print_Screen[PS_X]-Cursor_Texture_W;
        Cursor_fX = mkf(Cursor_X);
    }
    else if(Cursor_X < 0) {
        Cursor_X = 0;
    ...
    if((Cursor_Y+Cursor_Texture_H) > Print_Screen[PS_Y]) {
        Cursor_Y = Print_Screen[PS_Y]-Cursor_Texture_H;
        Cursor_fY = mkf(Cursor_Y);
    }
    else if(Cursor_Y < 0) {
        Cursor_Y = 0;
