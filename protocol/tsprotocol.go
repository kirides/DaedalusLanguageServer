...
// last fetched Wed Oct 19 2022 10:06:24 GMT+0200 (Mitteleuropäische Sommerzeit)
package protocol
...
/**
		 ...
		 * @since 3.17.0 - proposed state
		 */
		 EditRange Range `json:"editRange,omitempty"` /*Range | {
 insert: Range;
 replace: Range;
 }*/
...
/**
		 ...
		 */
		 Range bool `json:"range,omitempty"` /*boolean | {
		}*/
/**
